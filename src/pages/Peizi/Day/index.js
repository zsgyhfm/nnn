...
class Day extends PureComponent {
    ...
    _fetchPageData(token) {
        axios.post(`${api.PAGE_DAY}`, { token }).then(res => {
            const {
                money_range,
                day_rate_a,
                account_money,
            ...
            this.setState({
                ...
                duration: day_use_time,
                lineSetting: day_loss,
                multiple: day_rate_a,
                rate: day_rate_a,
                multipleRate: day_rate,
                position
            });
        });
    }
    ...
    render() {
        ...
        const durationItems = duration.map(item => {
            return { value: item, label: item + "天" };
        });
                    ...
                    <PageContainer>
                        ...
                        <WingBlank>
                            ...
                            <DurationSelect
                                ...
                                suffix="天"
                                items={durationItems}
                                placeholder={`操盘期限介于 ${minDuration} - ${maxDuration} 天之间`}
