...
class Month extends PureComponent {
    ...
    _fetchPageData(token) {
        axios.post(`${api.PAGE_MONTH}`, { token }).then(res => {
            const {
                money_range,
                month_rate_a,
                account_money,
            ...
            this.setState({
                ...
                duration: month_use_time,
                lineSetting: month_loss,
                multiple: month_rate_a,
                rate: month_rate_a,
                multipleRate: month_rate,
                position
            });
        });
    }
                    ...
                    <PageContainer>
                        ...
                        <WingBlank>
                            ...
                            <DurationSelect
                                ...
                                suffix="月"
                                items={durationItems}
                                placeholder={`操盘期限介于 ${minDuration} - ${maxDuration} 月之间`}
