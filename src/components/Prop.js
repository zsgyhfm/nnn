...
class Pops extends React.Component {
    ...
    handlePop(e) {
        ...
        const b = name.indexOf("Pop")!==-1;
        console.log(e.target.nodeName)
        const ty = e.target.nodeName;
        if (b||ty==="BUTTON"){
            this.props.click()
        }
    }
    ...
    componentWillMount() {
        //这里请求广告图数据 ，如果有key 设置为show   组件props {src,key}
        // axios.get()
    }
    ...
    render() {
        ...
        return (
            <Pop show={this.props.show} onClick={this.handlePop.bind(this)} className="Pop">
                <AdWraper className="animated bounceInDown">
                    <img
